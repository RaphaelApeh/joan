...
#define JNSTR_OBJ(s) (Jn_String){.chars = str_esc(s), .len = strlen((s)), .hash = djb2_hash((const unsigned char *)(s))}
...
JnObject* bind_argument(Jn_State*, JnObject* obj, char** fields, JnObject** values, long count);
#endif